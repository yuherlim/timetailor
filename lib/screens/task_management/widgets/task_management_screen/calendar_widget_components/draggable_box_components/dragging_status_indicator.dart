...
class DraggingStatusIndicator extends ConsumerWidget {
  ...
  const DraggingStatusIndicator({super.key, required this.isTopDraggingIndicator});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final textSize = const TimeIndicatorText(draggingOutput).getTextSize(context);
    final topPosition = isTopDraggingIndicator ? dy: dyBottom - textSize.height;
    ...
    if (isDragging) {
      return Positioned(
        left: leftPosition,
        top: !draggableBoxSizeIsSmall ? topPosition : isTopDraggingIndicator ? topPosition - 32 : topPosition + 32,
